...
# Analytic approach developed by: Lara J. Cushing and Sherlock Li                                                #
# Code by: Sherlock Li                                                                                           #
...
AIC_all_poissonmodel1<- cbind(AIC1969AB, AIC1999AB, AIC2019AB, AIC1969BC, AIC1999BC,AIC2019BC, AIC1969CD,AIC1999CD ,AIC2019CD)
colnames(AIC_all_poissonmodel1)<-c("AIC1969AB", "AIC1999AB", "AIC2019AB", "AIC1969BC", "AIC1999BC","AIC2019BC", "AIC1969CD","AIC1999CD" ,"AIC2019CD")
rownames(AIC_all_poissonmodel1)<-dvList
write.csv (AIC_all_poissonmodel1, "AIC_all_poissonmodel1.csv")
...
AIC_all_poissonmodel2 <- cbind(AIC1969AB, AIC1999AB, AIC2019AB, AIC1969BC, AIC1999BC,AIC2019BC, AIC1969CD,AIC1999CD ,AIC2019CD)
colnames(AIC_all_poissonmodel2)<-c("AIC1969AB", "AIC1999AB", "AIC2019AB", "AIC1969BC", "AIC1999BC","AIC2019BC", "AIC1969CD","AIC1999CD" ,"AIC2019CD")
rownames(AIC_all_poissonmodel2)<-dvList
write.csv (AIC_all_poissonmodel2, "AIC_all_poissonmodel2.csv")
...
AIC_all_nbmodel1 <- cbind(AIC1969AB, AIC1999AB, AIC2019AB, AIC1969BC, AIC1999BC,AIC2019BC, AIC1969CD,AIC1999CD ,AIC2019CD)
colnames(AIC_all_nbmodel1)<-c("AIC1969AB", "AIC1999AB", "AIC2019AB", "AIC1969BC", "AIC1999BC","AIC2019BC", "AIC1969CD","AIC1999CD" ,"AIC2019CD")
rownames(AIC_all_nbmodel1)<-"Number of Plants"
write.csv (AIC_all_nbmodel1, "AIC_all_nbmodel1.csv")
###############################################################################################################################
#model2
...
AIC_all_nbmodel2 <- cbind(AIC1969AB, AIC1999AB, AIC2019AB, AIC1969BC, AIC1999BC,AIC2019BC, AIC1969CD,AIC1999CD ,AIC2019CD)
colnames(AIC_all_nbmodel2)<-c("AIC1969AB", "AIC1999AB", "AIC2019AB", "AIC1969BC", "AIC1999BC","AIC2019BC", "AIC1969CD","AIC1999CD" ,"AIC2019CD")
rownames(AIC_all_nbmodel2)<-"Number of Plants"
write.csv (AIC_all_nbmodel2, "AIC_all_nbmodel2.csv")
############################################################################################################
############################################################################################################
...
colnames(r_model1)<-c("ab","bc","cd")
rownames(r_model1)<-dvList3
...
colnames(r_model2)<-c("ab","bc","cd")
rownames(r_model2)<-dvList3
...
result_spatial_time_3$lower_CL<-as.numeric(substr(result_spatial_time_3$lower_CL, 2, nchar(result_spatial_time_3$lower_CL)))
result_spatial_time_3$upper_CL<-as.numeric(substr(result_spatial_time_3$upper_CL, 1,nchar(result_spatial_time_3$upper_CL)-1))
...
result_spatial_no_time_3$lower_CL<-as.numeric(substr(result_spatial_no_time_3$lower_CL, 2, nchar(result_spatial_no_time_3$lower_CL)))
result_spatial_no_time_3$upper_CL<-as.numeric(substr(result_spatial_no_time_3$upper_CL, 1,nchar(result_spatial_no_time_3$upper_CL)-1))
...
result_spatial_time<-result_spatial_time[,c(-3,-6,-9,-12,-15,-18,-21,-24,-27)]
result_spatial_time<-result_spatial_time[c(1,6,11,16),]
result_spatial_time$Outcome<-c("Presence of power plant within 10km (PR)", "Presence of coal or oil plant within 10km (PR)", "Presence of peaker plant within 10km (PR)", "Number of power plants within 10km (IRR)")
rownames(result_spatial_time)<-c(1:4)
